...
export function buildSelfReviewPrompt(args: SelfReviewPromptArgs): string {
  ...
  blocks.push(
    [
      ...
      "4. Do NOT push commits, open pull requests, or create branches — the orchestrator",
      "   handles publishing after your review completes.",
      "5. Output your verdict as a JSON object in a fenced ```json block.",
      "",
      "# Output Format",
      "",
      "```json",
